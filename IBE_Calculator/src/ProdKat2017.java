...
public class ProdKat2017 {
	...
	public ProdKat2017(ControllerMain c,TreeMap<String, BigDecimal> treeMap, BigDecimal zuggew, ArrayList<String> halte){
		this.cm = c;
	...
	public void init(TreeMap<String, BigDecimal> treeMap, BigDecimal zuggew, ArrayList<String> halte) {
		System.out.println("Verkehrsart ProdKat17:" + this.cm.getVerkehrsart());
		System.out.println("Zuggew in ProdKat17: "+ zuggew);
		System.out.println("halte in ProdKat17");
		this.halte = halte;
		for(int i = 0; i < halte.size(); i++){
			System.out.println(halte.get(i));
		}
		System.out.println(ExcelHandler.stationen17.size());
		strecke = treeMap;
		zugGew = zuggew;
		
		for(int i = 0; i < halte.size(); i++){
			halteGes = halteGes.add(ExcelHandler.stationen17.get(halte.get(i)));
		}
		this.cm.getTextFieldHalte().setText(halteGes.setScale(2, BigDecimal.ROUND_UP).toString());
		this.cm.getTextFieldTfzFak().setText(ExcelHandler.pk17Kat.get(this.cm.getTfzKat()).setScale(4, BigDecimal.ROUND_UP).toString());
		System.out.println("Init in ProdKat17");
		calcBtkm();
		calcIBE();
	}
	...
	private void calcBtkm() {
		...
		this.btkm = this.btkm.multiply(ExcelHandler.pk17Btk);
	...
	public void calcIBE() {
		...
		if(this.cm.getVerkehrsart().contains("RZ")){
			if(ExcelHandler.stationen17.containsKey(this.cm.getDB640von().getText()) && (!this.halte.contains(this.cm.getDB640von().getText()))){
				halteGes = halteGes.add(ExcelHandler.stationen17.get(this.cm.getDB640von().getText()));
			}
			if(ExcelHandler.stationen17.containsKey(this.cm.getDB640bis().getText()) && (!this.halte.contains(this.cm.getDB640bis().getText()))){
				halteGes = halteGes.add(ExcelHandler.stationen17.get(this.cm.getDB640bis().getText()));
			}
			
			this.cm.getTextFieldHalte().setText(halteGes.setScale(2, BigDecimal.ROUND_UP).toString());
			
			ibeWa = strecke.get("WA").multiply(ExcelHandler.pk17RZ.get("WA"));
			ibeBr = strecke.get("BR").multiply(ExcelHandler.pk17RZ.get("BR"));
			ibeIa = strecke.get("IA").multiply(ExcelHandler.pk17RZ.get("IA"));
			ibeKn = strecke.get("KN").multiply(ExcelHandler.pk17RZ.get("KN"));
			ibeEn = strecke.get("EN").multiply(ExcelHandler.pk17RZ.get("EN"));
			ibeGes = strecke.get("Ges").multiply(ExcelHandler.pk17Kat.get(this.cm.getTfzKat()));
		...
		if(this.cm.getVerkehrsart().contains("GZ")){
			ibeWa = strecke.get("WA").multiply(ExcelHandler.pk17GZ.get("WA"));
			ibeBr = strecke.get("BR").multiply(ExcelHandler.pk17GZ.get("BR"));
			ibeIa = strecke.get("IA").multiply(ExcelHandler.pk17GZ.get("IA"));
			ibeKn = strecke.get("KN").multiply(ExcelHandler.pk17GZ.get("KN"));
			ibeEn = strecke.get("EN").multiply(ExcelHandler.pk17GZ.get("EN"));
			ibeGes = strecke.get("Ges").multiply(ExcelHandler.pk17Kat.get(this.cm.getTfzKat()));
		...
		if(this.cm.getVerkehrsart().contains("EWFV")){
			ibeWa = strecke.get("WA").multiply(ExcelHandler.pk17EWFV.get("WA"));
			ibeBr = strecke.get("BR").multiply(ExcelHandler.pk17EWFV.get("BR"));
			ibeIa = strecke.get("IA").multiply(ExcelHandler.pk17EWFV.get("IA"));
			ibeKn = strecke.get("KN").multiply(ExcelHandler.pk17EWFV.get("KN"));
			ibeEn = strecke.get("EN").multiply(ExcelHandler.pk17EWFV.get("EN"));
			ibeGes = strecke.get("Ges").multiply(ExcelHandler.pk17Kat.get(this.cm.getTfzKat()));
		...
		if(this.cm.getVerkehrsart().contains("DZ")){
			ibeWa = strecke.get("WA").multiply(ExcelHandler.pk17DZ.get("WA"));
			ibeBr = strecke.get("BR").multiply(ExcelHandler.pk17DZ.get("BR"));
			ibeIa = strecke.get("IA").multiply(ExcelHandler.pk17DZ.get("IA"));
			ibeKn = strecke.get("KN").multiply(ExcelHandler.pk17DZ.get("KN"));
			ibeEn = strecke.get("EN").multiply(ExcelHandler.pk17DZ.get("EN"));
			ibeGes = strecke.get("Ges").multiply(ExcelHandler.pk17Kat.get(this.cm.getTfzKat()));
